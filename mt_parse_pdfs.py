...
def handle_futures(futures):
    ...
    for future in concurrent.futures.as_completed(futures):
        try:
            ...
            print(f"Exception occurred while processing file: {futures[future]}")
            print(e)
...
def after_processing(results, files):
    ...
    """
    print("All files have been processed. Performing post-processing steps...")
    ...
    try:
        ...
        if os.path.isdir(pdf_file_path):
            ...
            with concurrent.futures.ThreadPoolExecutor(max_workers=max_threads) as executor:
                ...
                futures = submit_tasks(executor, pdf_file_path, files, output_struct)
